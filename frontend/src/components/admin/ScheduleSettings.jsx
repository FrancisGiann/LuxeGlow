...
export function ScheduleSettings({ onOpenAppointments }) {
  ...
  if (loading) return <Card className="p-8"><div className="flex items-center gap-3 text-sm text-ink-500" role="status"><Spinner size="sm" tone="brand" />Loading salon schedule…</div></Card>;
